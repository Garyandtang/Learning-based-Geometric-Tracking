...
def single_test():
    ...
    ax1.set_title('Reference Trajectory vs Trajectory with Initial Parameters')
    ...
    ax2.set_title('Reference Trajectory vs Trajectory with Reconstructed Parameters')
